output "codecommit_repoid" {
  value       = module.codecommit_infrastructure_source_repo.repository_id
  description = "The name of the Codecommit repository"
}

output "codecommit_httpurl" {
  value       = module.codecommit_infrastructure_source_repo.clone_url_http
  description = "The Clone URL of the Codecommit repository"
}

output "codecommit_sshurl" {
  value       = module.codecommit_infrastructure_source_repo.clone_url_ssh
  description = "The Clone URL of the Codecommit repository"
}
